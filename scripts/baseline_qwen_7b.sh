...
for benchmark in viscot blink vstar tetris; do
    sbatch \
        ...
        --output="/mnt/scratch-artemis/gviveiros/lantern/logs/baseline_qwen_7b_${benchmark}_%j.out" \
        --error="/mnt/scratch-artemis/gviveiros/lantern/logs/baseline_qwen_7b_${benchmark}_%j.err" \
        --wrap="
